...
const vector<string> dpiNames = {"DPI1"};
...
bool gety(const char dpi[MAX_DPINAME_LENGTH],
...
bool getcov(const char dpi[MAX_DPINAME_LENGTH],
...
bool getbatch(char batch[ENCLAVE_READ_BUFFER_SIZE]) {
    ...
    // if data stream from this dpi has reached eof,
